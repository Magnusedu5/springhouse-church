          ...
          <div className="space-y-7">
            ...
            <DriftIn direction="left" delay={0.5}>
              <div>
                ...
                <div className="flex gap-3">
                  {[
                    { label: 'Facebook', icon: <FacebookIcon />, href: 'https://www.facebook.com/thespringhousecommunity' },
                    { label: 'Instagram', icon: <InstagramIcon />, href: 'https://www.instagram.com/thespringhousechurch' },
                    { label: 'YouTube', icon: <YouTubeIcon />, href: 'https://www.youtube.com/@thespringhousecommunity5008' },
                    { label: 'X', icon: <XIcon />, href: 'https://x.com/thespringhouse' },
                  ].map(({ label, icon, href }) => (
                    <a
                      key={label}
                      href={href}
